...
function MoviePage() { // Mediatyypin arvo on joko 'movie' tai 'tv' ja valitaan MovieSearch -sivulla, josta se tulee tähän funktioon
    ...
    if (movieID) {
      const fetchMovieDetails = async () => {
        try {
          ...
          const response = await fetch(`https://api.themoviedb.org/3/${mediaType}/${movieID}?language=en-US&api_key=${API_KEY}`, options);
